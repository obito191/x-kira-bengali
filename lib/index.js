...
const { getJson, getBuffer } = require("./handier");
const { getRandomWelcomeText, getRandomGoodbyeText } = require("./randomtext");
      ...
      if (connection === "open") {
        ...
        conn.ev.on("group-participants.update", async (update) => {
          ...
          for (const user of participants) {
            ...
            const rawMessage = getRandomWelcomeText();
            ...
            await conn.sendMessage(groupJid, {
              ...
              contextInfo: {
                externalAdReply: {
                  ...
                  body: `Group Members: ${groupSize}`,
                  thumbnail: await getBuffer(profileImage),
                  mediaType: 1,
        ...
        conn.ev.on("group-participants.update", async (update) => {
          ...
          for (const user of participants) {
            ...
            const rawMessage = getRandomGoodbyeText();
            ...
            await conn.sendMessage(groupJid, {
              ...
              contextInfo: {
                externalAdReply: {
                  ...
                  body: `Remaining Members: ${groupSize}`,
                  thumbnail: await getBuffer(profileImage),
                  mediaType: 1,
                  sourceUrl: "https://wa.me/" + user.split("@")[0],
                },
        ...
        const calltext = ["∂σит ¢αℓℓ мє.","Sorry, রিফাত এখন পড়ালেখায় মনোযোগী কল করো না"];
        const callt = calltext[Math.floor(Math.random() * calltext.length)];
